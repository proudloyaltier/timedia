...
function setupTiSmile(stage) {
  if (stage == 0) {
    ...
    document.getElementById("tismile-stage1").style.display = "";
  } else if (stage == 1) {
    context.drawImage(video, 0, 0, 640, 480);
    document.getElementById("tismile-stage1").style.display = "none";
    document.getElementById("tismile-stage2").style.display = "";
  } else if (stage == 2) {
    alertify
      .defaultValue("")
      .prompt("Please Enter Your Password",
        function(val) {
          if (MD5(val) == localStorage.tismilepassword) {
            ...
            document.getElementById("tismile-stage3").style.display = "";
          } else {
...
if (isMobile.any()) {
  ...
  document.getElementById("ti-smile-settings-text").style.display = "";
}
