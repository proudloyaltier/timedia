...
var settings = {
  settings: {
    ...
    Tiles: '<h5>Tiles</h5><br><br><button onclick="lastTile()" class="btn btn-success">Open The Last Opened Tile</button><br><br><button onclick="resetTiles()" class="btn btn-danger">Reset Tiles</button><br>',
    ...
    TiSmile: '<img src="other resources/smile.png" width="100" height="100"><br><h4><b>Introducing TiSmile</b> - Unlock with a smile.</h4><button onclick="window.location.href='+"index.html?app=11"+'" class="btn btn-primary">Open TiSmile Preferences</button><br>'
  }
};
