document.getElementById("ti-work").onclick = function() {
  ...
  setTimeout(function() {
    ...
    document.getElementById('docs-icon').style.left = 'calc(91.5% - 70px)';
    document.getElementById('sheets-icon').style.top = '80%';
    document.getElementById('sheets-icon').style.left = '91.5%';
    document.getElementById('bookmarks-icon').style.top = '90%';
    document.getElementById('bookmarks-icon').style.left = 'calc(91.5% - 70px)';
    document.getElementById('slides-icon').style.left = '91.5%';
