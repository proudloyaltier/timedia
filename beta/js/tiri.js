...
function tt() {
         ...
         if (localStorage.us == 'i have a problem') {
            ...
            responsiveVoice.speak("Sorry. I do not understand");
            localStorage.ts = "Sorry, I do not understand.<br><button class='btn btn-primary' onclick='window.open(&quot;https://www.google.com/search?q=" + localStorage.us + "&quot;)&quot;>Search the Web for " + localStorage.us + "</button>";
         }
}
