...
function saveDoc() {
  if (localStorage.tidocssave == undefined) {
    ...
    window.dbRef.child("users").child(localStorage.name).child("docs").child(tidocssave).child(localStorage.name).set(CryptoJS.AES.encrypt(document.getElementById('tidocsContent').innerHTML, localStorage.password) + "");
    localStorage.tidocssave = tidocssave;
    var urlRef = window.dbRef.child("users").child(localStorage.name).child("docs").child(tidocssave);
    ...
    window.dbRef.child("users").child(localStorage.name).child("docs").child(localStorage.tidocssave).child(localStorage.owner).set(CryptoJS.AES.encrypt(document.getElementById('tidocsContent').innerHTML, localStorage.password) + "");
